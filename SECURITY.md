...
For `casonk.github.io`, security-sensitive reports should be handled privately by the repository owner.
...
- Do not commit private source documents, recommendation letters, transcripts, or other local-only portfolio materials.
